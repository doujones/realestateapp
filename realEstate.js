...
class App extends Component {
  ...
  filteredData(){
    ...
    //Added Filter 
    let checkboxFilter = ['tennis_court', 'swimming_pool', 'basketball_court', 'gym'];
    checkboxFilter.forEach( row => {
      if(this.state[row] != undefined && this.state[row] == true){
        newData = newData.filter((item) => {
          return item.extras.includes(row);
        })
      }
    });
