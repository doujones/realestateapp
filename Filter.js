  ...
  render () {
    ...
    <div className="filters extras">
      ...
      <label htmlFor="extras">
        ...
        <input name="elavator" value="Tennis_Court" type="checkbox"  onChange={this.props.change}/>
      </label>
      <label htmlFor="extras">
      ...
      <label htmlFor="extras">
        ...
        <input name="Basketball_Court" value="finished basement" type="checkbox"  onChange={this.props.change} />
      </label>
      <label htmlFor="extras">
        <span>Gym</span>
